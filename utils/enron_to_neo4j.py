...
with open (enron_neo4j_path / 'relationships.csv', "w") as rel_file:
    ...
    rel_writer.writerow({"sender":":START_ID","email_date":"email_date:date","email_subject":"email_subject","email_message_id":"email_message_id","transaction_type":"transaction_type","routing":"routing","receiver":":END_ID","rel_type":":TYPE"})
    for index, row in df_relationships.iterrows():
        ...
        rel_dict["email_date"] = row["email_date"]
