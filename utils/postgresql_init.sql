CREATE USER cdh WITH PASSWORD 'cdhpass';
CREATE DATABASE cdh_db;
GRANT ALL PRIVILEGES ON DATABASE cdh_db TO cdh;
\connect cdh_db cdh
...
COPY email FROM '/docker-entrypoint-initdb.d/emails.csv' DELIMITER ',' CSV HEADER;
...
COPY employee FROM '/docker-entrypoint-initdb.d/unique_users_with_names.csv' DELIMITER ',' CSV HEADER;
